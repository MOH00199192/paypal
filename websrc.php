...
<div class="span8" id="js_activityCollection">
                <section class="activityModule shadow none" aria-labelledby="activityModuleHeaderNone">
                    <h1 style="font-size: 18px;font-weight: bold; border-bottom: 1px solid #EEE; height:40px;">Resolution Center</h1>
                    <div></div>
                    <div id="parentchild">
					...
					<ul id="js_profileStates" class="profileStates center" <?php echo 'style="margin: auto"';  ?>> 
						...
						<li><a class="state nextState" target="_blank"><span class="icon icon-medium icon-bank-check" aria-hidden="true"></span></a>Update &#x0042;ank And Identity</li>
					</ul>
					</div>
